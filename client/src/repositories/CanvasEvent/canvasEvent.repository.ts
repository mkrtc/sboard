...
import { CanvasException, GetEventsFilter } from "./canvasEvent.types";
...
export class CanvasEventRepository {
    ...
    public createFigure(fromEventId?: string) {
        this.socketProvider.emit(CREATE_FIGURE_EVENT, {fromEventId});
    }
